...
export const ManualMode: React.FC<{setModeLock: React.Dispatch<React.SetStateAction<boolean>>}> = ({setModeLock}) => {
  ...
  return (
    <>
      ...
      <p className="collapse-title text-xl font-medium">Original Desktop ID: <input className="input input-bordered input-success input-sm w-full max-w-xs text-xl" ref={desktopIdRef}/></p>
      <p className="collapse-title text-xl font-medium">Original Desktop Password: <input className="input input-bordered input-success input-sm w-full max-w-xs text-xl" ref={passwordRef} defaultValue={"impromptu"} /></p>
